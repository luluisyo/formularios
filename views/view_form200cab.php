...
<body>
  ...
  <table id="example" class="display table table-bordered table-hover nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            $sql=("select f.idform,f.requiriente,f.emprersa,f.area,f.proveedor,f.cheque,f.proforma,condicion,fecha,proyecto,sum(r.total) as suma from requerimiento r, form200 f where f.idform=r.idform group by r.idform");
            ...
            while($arreglo=mysqli_fetch_array($query)){
             echo "<tr>";
              ...
              echo "<td><a class='button' href='../views/update_form200.php?id=$arreglo[0]'>Modificar</a> <a class='button' href='?id=$arreglo[0]#eli' style='background:#FF3B3B'>Eliminar</a>
              <a class='button' href='?id=$arreglo[0]#openModal'>VER</a> ";
           
               echo "<a class='button' href='?id=$arreglo[0]#term'>Finalizar</a>";
